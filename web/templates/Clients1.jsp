...
<!--  <div class="login-html">-->
     ...
     <form id="login_form" method="post" action="All_List.jsp">

            
         <div class="group">
             <div style="margin: 12px;">
                 <label class="label" style="">SELECT CLIENT</label>
             </div>
                  <div class="SelectClient" placeholder="Select Company" required="" >
                         <%try{
                             String alfa=request.getParameter("alfa");
                              ds1= new DataService();
                              rs=ds1.create_empclientA_data(alfa);
                              ar=new ArrayList();
                              while(rs.next())
...
<!--             <select name="company_name" id="company_name" class="" style="height:32px; background-color:whitesmoke ; border:0px ;color: black; border-radius:10px;width:385px;height:45px;margin-left:2px;">-->
             <select name="company_name" id="company_name" class="form-control select-company" style="">
                 <optgroup label="company_name" class="company-option">
...
<br>
             <div class="group">
                 <center>    
                     <input type="submit" value="Submit" class="btn btn-default client-submit input" style="">
                 </center>
<br>          </div>
