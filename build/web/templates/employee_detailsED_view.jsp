...
<!--                        <th style="background-color: darkcyan">CLIENT NAME</th>-->
                    ...
                    ResultSet rs=st.executeQuery("select Date1,CLIENTS_LIST,UAN_NO,Full_Name,EMP_NO,Pf_No,sname,Father_Name,relationship,Date_Of_Birth,pencel,Date,Bank_Name,Account_No,IFSC_Code,Adhar_No,adharadd,Pan_No,Mobile_No from recruitment_table");
