...
public class Recruitment_Combo_Servlet extends HttpServlet {
...
//Ifsc_noESIC_nopf_no_abank_nameaccno
    try
    {
       ...
       System.out.println("fulname=combobox===>"+fulname);
     ...
     System.out.println("jkjkj "+rs.getString(1)+"-"+rs.getString(2)+"-"+rs.getString(3)+"-"+rs.getString(4)+"-"+rs.getString(5)+"-"+rs.getString(6)+"-"+rs.getString(7));
